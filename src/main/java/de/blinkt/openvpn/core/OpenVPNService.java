...
public class OpenVPNService extends VpnService implements StateListener, Callback, ByteCountListener, IOpenVPNServiceInternal {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        // PIA is only using the temporary VPN profile
        // -> delete the temporary file once the profile has been read
        ProfileManager.getInstance(this).removeProfile(this, mProfile, true);
    ...
    public void setLocalIPv6(String ipv6addr) {
        Log.d("OpenVPN Service", "Adding ipv6: " + ipv6addr);
        mLocalIPv6 = ipv6addr;
    }
