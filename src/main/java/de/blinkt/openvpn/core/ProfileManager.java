...
public class ProfileManager {
    ...
    public static void setConntectedVpnProfileDisconnected(Context c) {
        MultiPreferences prefs = Preferences.getDefaultSharedPreferences(c);
        prefs.removePreference(LAST_CONNECTED_PROFILE);
    }
    ...
    public static void setConnectedVpnProfile(Context c, VpnProfile connectedProfile) {
        MultiPreferences prefs = Preferences.getDefaultSharedPreferences(c);
        prefs.setString(LAST_CONNECTED_PROFILE, connectedProfile.getUUIDString());
    ...
    public void saveProfileList(Context context) {
        SharedPreferences sharedprefs = Preferences.getSharedPreferences(PREFS_NAME, context);
    ...
    private void loadVPNList(Context context) {
        ...
        SharedPreferences listpref = Preferences.getSharedPreferences(PREFS_NAME, context);
    ...
    public void removeProfile(Context context, VpnProfile profile, boolean isTemporary) {
        String filename = profile.getUUID().toString() + ".vp";
        if (isTemporary)
            filename = TEMPORARY_PROFILE_FILENAME + ".vp";
    ...
    public static VpnProfile getAlwaysOnVPN(Context context) {
        checkInstance(context);
        MultiPreferences prefs = Preferences.getDefaultSharedPreferences(context);
